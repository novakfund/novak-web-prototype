      ...
      <div className="max-w-4xl w-4/5 mx-auto px-3 md:px-20 pt-4">
        <form className="w-full bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          <div className="mb-4">
            ...
            <input
              className={
                (this.state.emailError ? "border-red-500" : "") +
          ...
          <div className="flex flex-col md:flex-row justify-between mb-4">
            <div className="w-full mr-4">
              ...
              <input
                className={
                  (this.state.firstNameError ? "border-red-500" : "") +
                  " shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                }
                name="inputEmail"
            ...
            <div className="w-full mt-2 md:mt-0">
              ...
              <input
                className={
                  (this.state.lastNameError ? "border-red-500" : "") +
                  " shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                }
                name="inputEmail"
          ...
          <div className="mb-6">
            ...
            <textarea
              className={
                (this.state.exerpError ? "border-red-500" : "") +
                " shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline resize-y h-48"
              }
              name="inputExerpt"
            ...
            {this.state.exerpError && (
              <p className="text-red-500 text-xs italic">
                Please enter a quick exerpt about you
              </p>
            )}
          </div>
